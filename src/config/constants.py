...
MESSAGES_RU = {
    ...
    "cancelled": "✖ Отменено.",
    "habits_update_prompt": "✏️ Отправь дополнение к записи. Я добавлю его к предыдущему черновику.",
...
MESSAGES_EN = {
    ...
    "saved_success": "✅ Saved!",
    "cancelled": "✖ Cancelled.",
    "habits_update_prompt": "✏️ Send more text. I'll add it to the previous draft.",
